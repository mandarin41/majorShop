...
<html>
	...
	<body>
		<table cellspacing="0" width="100%" height=1500 border=0>
			...
			<tr class = underhead height = "5%">
				<td colspan = "3">
					<p class = refer><a href = "../index.php">Главная>>></a><a href = "../php/sports.php">Все для спорта</a></p>
				</td>
	...
	<?php
		...
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("SPORTS-1", $arr[$i]);
		...
		echo '<tr class = good1 height = "20%">
				...
				<td  colspan = "2" align = "center">
					...
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="SPORTS-1"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
			
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("SPORTS-2", $arr[$i]);
		...
		echo '<tr class = good2 height = "20%">
				...
				<td  colspan = "2" align = "center">
					<font size = 6>'.$arr[$i-1]['price'].'</font>
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="SPORTS-2"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
		
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("SPORTS-3", $arr[$i]);
		...
		echo '<tr class = good3 height = "20%">
				...
				<td  colspan = "2" align = "center">
					<font size = 6>'.$arr[$i-1]['price'].'</font>
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="SPORTS-3"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
	?>
