...
<html>
	...
	<body>
		<table cellspacing="0" width="100%" height=1500 border=0>
			...
			<tr class = underhead height = "5%">
				<td colspan = "3">
					<p class = refer><a href = "../index.php">Главная>>></a><a href = "../php/home.php">Все для дома</a></p>
				</td>
	...
	<?php
		...
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("HOME-1", $arr[$i]);
		
		echo '<tr class = good1 height = "20%">
				<td width = 25% colspan = "2">
					<img class = "goods" src = "'.$arr[$i-1]['pic'].'" width = "60%">
				</td>
				<td colspan = "4">
				...
				<td  colspan = "2" align = "center">
					...
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="HOME-1"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
			
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("HOME-2", $arr[$i]);
		...
		echo '<tr class = good2 height = "20%">
				...
				<td  colspan = "2" align = "center">
					<font size = 6>'.$arr[$i-1]['price'].'</font>
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="HOME-2"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
		
		for ($i=1, $key=false;$key === false; $i++)
			$key = array_search("HOME-3", $arr[$i]);
		...
		echo '<tr class = good3 height = "20%">
				...
				<td  colspan = "2" align = "center">
					<font size = 6>'.$arr[$i-1]['price'].'</font>
					<p><form method="post" action="../php/goodpage.php"><input type="submit" value="Купить" name="HOME-3"  style="height:50px; width:100px"></form></p>
				</td>
			</tr>';
	?>
